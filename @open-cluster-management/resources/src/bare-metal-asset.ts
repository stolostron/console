...
import {
    ...
    IRequestResult,
    listResources,
} from "./utils/resource-request";

export const BareMetalAssetApiVersion =
    "inventory.open-cluster-management.io/v1alpha1";
export type BareMetalAssetApiVersionType =
    "inventory.open-cluster-management.io/v1alpha1";
...
export function createBareMetalAssetNamespaces(
    assets: ImportedBareMetalAsset[]
) {
...
export function importBareMetalAsset(
    asset: ImportedBareMetalAsset
): IRequestResult {
    return {
