          ...
          label={
            <div style={{ display: 'flex', alignItems: 'center' }}>
              ...
              {!isEditingTargetStorage && (
                <button
                  type="button"
                  onClick={() => setIsEditingTargetStorage(true)}
                  style={{
                    marginLeft: '1rem',
                    background: 'none',
                    border: 'none',
  ...
  return (
    <>
      <div style={{ display: 'flex', flexDirection: 'column', width: 'fit-content' }}>
        <Button
          style={{ marginTop: '-3.5rem', marginLeft: '12rem', textAlign: 'end' }}
          variant="link"
          onClick={() => {
        ...
        <div style={{ display: 'flex', flexDirection: 'column', width: 'fit-content', marginTop: '1rem' }}>
      ...
      <Divider
        style={{ marginLeft: '-2rem', width: '120%', marginTop: '1rem' }}
        inset={{ default: 'insetNone' }}
        className="pf-v6-c-divider"
      />
      <div style={{ display: 'flex', height: '100%' }}>
        <div style={{ minWidth: 240, maxWidth: 260 }}>
          <Tabs
            ...
            role="region"
            className="--pf-v6-c-divider--Color"
            style={{
              marginLeft: '-1.6rem',
              height: '110%',
          ...
          >
            {readinessTabs.map((tab, idx) => (
              <Tab
                ...
                // style={{ padding: '0.8rem 1.6rem', marginTop:'-1.6rem', borderRight: '1px solid #d2d2d2' }}
              />
            ))}
          </Tabs>
        </div>
            ...
            component: (
              <Split hasGutter style={{ marginTop: '1rem' }}>
                ...
                >
                  ...
                  <FormGroup label="Cluster" fieldId="srcCluster" style={{ margin: '1rem 1rem 0rem 1rem' }}>
                    <TextInput
                      isRequired
                      type="text"
                  ...
                  <FormGroup label="Project" fieldId="srcNs" style={{ margin: '1rem 1rem 0rem 1rem' }}>
                    <TextInput
                      isRequired
                      type="text"
                      id="simple-form-name-01"
