...
describe('validation', () => {
    ...
    describe('validatePrivateSshKey', () => {
        test.each(
            [
                [`should allow valid openssh key`,'-----BEGIN OPENSSH PRIVATE KEY-----\nkey\n-----END OPENSSH PRIVATE KEY-----', true ],
                ...
                [`should not allow end line next to the begin line`,  '-----BEGIN A PRIVATE KEY-----\n-----END A PRIVATE KEY-----', false ],
            ],
        )('%s',(name,value,isValid)=>{
            if (!isValid) {
    ...
    describe('validateCertificate', () => {
        test.each(
            [
                ...
                [`should not allow end line next to the begin line`,  '-----BEGIN CERTIFICATE-----\n-----END CERTIFICATE-----', false ],
            ],
        )('%s',(name,value,isValid)=>{
            if (!isValid) {
