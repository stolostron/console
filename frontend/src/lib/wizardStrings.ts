...
export const useWizardStrings = (
  ...
  return useMemo(
    () => ({
      ...
      reviewShowChangesOnlyLabel: t('wizard.review.showChangesOnlyLabel'),
      reviewBooleanTrue: t('True'),
      reviewBooleanFalse: t('False'),
      reviewBooleanNotSet: t('Not set'),
      reviewArrayInstanceAdded: t('wizard.review.arrayInstanceAdded'),
      reviewArrayInstanceDeleted: t('wizard.review.arrayInstanceDeleted'),
      reviewArrayInstanceModified: t('wizard.review.arrayInstanceModified'),
