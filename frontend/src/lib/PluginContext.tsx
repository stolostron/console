...
export const defaultPlugin: Plugin = {
  ...
  acmExtensions: {},
  ocpApi: {
    // TODO: implement basic version of timestamp (e.g. without translation and relative times) for local development
    Timestamp: () => (
      <div>
        TODO: implement <code>&lt;Timestamp /&gt;</code> component for standalone dev console
      </div>
    ),
