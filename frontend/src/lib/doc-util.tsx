...
export const DOC_LINKS = {
    ...
    CREATE_CONNECTION_BAREMETAL: `${DOC_BASE_PATH}/multicluster_engine/index#credentials`,
    ...
    CREATE_CONNECTION_PROXY_BAREMETAL: `${DOC_BASE_PATH}/multicluster_engine/index#proxy-bare`,
    ...
    GLOBAL_CLUSTER_SET: `${DOC_BASE_PATH}/multicluster_engine/index#managedclustersets-intro`,
