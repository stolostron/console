...
export const DOC_LINKS = {
    ...
    CREATE_CLUSTER: `${DOC_BASE_PATH}/multicluster_engine/cluster_lifecycle/cluster_overview#creating-a-cluster`,
    CREATE_CLUSTER_ON_PREMISE: `${DOC_BASE_PATH}/multicluster_engine/cluster_lifecycle/cluster_overview#creating-a-cluster-on-premises`,
    IMPORT_CLUSTER: `${DOC_BASE_PATH}/multicluster_engine/cluster_lifecycle/cluster_overview#importing-a-target-managed-cluster-to-the-hub-cluster`,
    CLUSTER_SETS: `${DOC_BASE_PATH}/multicluster_engine/cluster_lifecycle/cluster_overview#managedclustersets`,
    GLOBAL_CLUSTER_SET: `${DOC_BASE_PATH}/multicluster_engine/cluster_lifecycle/cluster_overview#managedclustersets`,
    CLUSTER_POOLS: `${DOC_BASE_PATH}/multicluster_engine/cluster_lifecycle/cluster_overview#managing-cluster-pools`,
    CLUSTER_CLAIMS: `${DOC_BASE_PATH}/multicluster_engine/cluster_lifecycle/cluster_overview#claiming-clusters-from-cluster-pools`,
    ...
    INFRASTRUCTURE_EVIRONMENTS: `${DOC_BASE_PATH}/multicluster_engine/cluster_lifecycle/cluster_overview#creating-an-infrastructure-environment`,
    DISCOVERED_CLUSTERS: `${DOC_BASE_PATH}/multicluster_engine/cluster_lifecycle/cluster_overview#discovery-intro`,
    MACHINE_POOLS: `${DOC_BASE_PATH}/multicluster_engine/cluster_lifecycle/cluster_overview#resizing-a-cluster`,
    MANAGE_APPLICATIONS: `${DOC_BASE_PATH}/applications/managing-applications`,
    ANSIBLE_JOBS: `${DOC_BASE_PATH}/multicluster_engine/cluster_lifecycle/cluster_overview#ansible-config-cluster`,
    ...
    HYPERSHIFT_INTRO: `${DOC_BASE_PATH}/multicluster_engine/hosted_control_planes/hosted_control_planes#hosted-control-planes-intro`,
}
