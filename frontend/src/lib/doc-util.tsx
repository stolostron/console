...
export const DOC_LINKS = {
    ...
    CIM_CONFIG_DISONNECTED: `${DOC_BASE_PATH}/multicluster_engine/index#enable-cim`,
    CIM_CONFIG: `${DOC_BASE_PATH}/multicluster_engine/index#enable-cim`,
    CIM_CONFIG_AWS: `${DOC_BASE_PATH}/multicluster_engine/index#enable-cim-aws`,
