...
export const DOC_LINKS = {
  ...
  CREATE_CONNECTION_REDHATCLOUD_API_TOKEN: `${DOC_BASE_PATH}/clusters/index#creating-a-credential-for-openshift-cluster-manager`,
  CREATE_CONNECTION_REDHATCLOUD_SERVICE_ACCOUNT: `${DOC_BASE_PATH}/clusters/index#creating-a-credential-for-openshift-cluster-manager`,
