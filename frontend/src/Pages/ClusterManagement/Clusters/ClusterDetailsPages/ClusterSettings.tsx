...
import { QueryClusterManagementAddons, ClusterManagementAddOn } from '../../../../lib/ClusterManagementAddOn'
import {
    ManagedClusterAddOn,
    QueryManagedClusterAddOns as GetManagedClusterAddOns,
...
export function ClustersSettingsPageContent(props: { name: string; namespace: string }) {
    const cma = QueryClusterManagementAddons()
