...
import { ProviderConnection, QueryProviderConnections, providerConnections } from '../../../lib/ProviderConnection'
...
export function ProviderConnectionsPageContent() {
    const { loading, error, data, startPolling, stopPolling, refresh } = QueryProviderConnections()
