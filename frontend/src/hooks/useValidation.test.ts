...
describe('validation', () => {
  ...
  describe('validateWebURL', () => {
    test.each([
      ...
      ['should allow an OCI URL', 'oci://registry.example.com/charts/my-chart', undefined],
      ['should allow an OCI URL without path', 'oci://registry.example.com', undefined],
      ['should allow an OCI URL with port', 'oci://registry.example.com:5000/charts/my-chart', undefined],
