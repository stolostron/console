...
describe('ProjectCreateForm', () => {
  ...
  it('calls validation functions when fields change', async () => {
    ...
    await typeElement(nameInput, 'test-name')
  ...
  it('submits form with valid data', async () => {
    ...
    await typeElement(nameInput, 'test-project')
    await typeElement(displayNameInput, 'Test Project')
    await typeElement(descriptionInput, 'A test project description')
