...
export enum NavigationPath {
  ...
  policyDetailsHistory = '/multicloud/governance/policies/details/:namespace/:name/template/:clusterName/:apiGroup?/:apiVersion/:kind/:templateName/history',
  ...
  discoveredPolicyDetailsHistory = '/multicloud/governance/discovered/:apiGroup/:apiVersion/:kind/:templateName/:templateNamespace?/:clusterName/history',
