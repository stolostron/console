...
/**
 * __useSearchSubscriptionSubscription__
 *
 * To run a query within a React component, call `useSearchSubscriptionSubscription` and pass it any options that fit your needs.
 * When your component renders, `useSearchSubscriptionSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSearchSubscriptionSubscription({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useSearchSubscriptionSubscription(
...
export type SearchSubscriptionSubscriptionHookResult = ReturnType<typeof useSearchSubscriptionSubscription>
