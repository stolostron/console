...
import { IRequestModalProps, RequestModal } from '../../../components/RequestModal'
...
export function AddConnectionPageContent(props: { projects: Project[] }) {
    ...
    const [requestModalProps, setRequestModalProps] = useState<IRequestModalProps>()
                        ...
                        <AcmSubmit
                            ...
                            onClick={() => {
                                ...
                                setRequestModalProps({
                                    ...
                                    open: true,
                                    close: (success) => {
                                        setRequestModalProps(undefined)
                                        if (success) {
                                            history.push(NavigationPath.providerConnections)
                                        }
                                    },
                                    action: () => createProviderConnection(providerConnection),
                                })
                            }}
                        >
                            Add connection
