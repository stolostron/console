...
describe('getResourcesClustersForApp', () => {
    ...
    it('returns search nodes WITHOUT local host, the placement rule is not deploying on local', () => {
        expect(getResourcesClustersForApp(searchClusters, nodesWithoutPlacementOnLocal)).toEqual(
...
describe('getRouteNameWithoutIngressHash', () => {
    const node = {
        ...
        cluster: 'local-cluster',
        kind: 'subscription',
        label: 'app=ingress-nginx; hosting-deployable-name=ingress-nginx-subscription-1-deployable; subscription-pause=false',
        localPlacement: 'true',
    ...
    const itemNoAvailableReady = [
        {
            ...
            cluster: 'fxiang-eks',
            desired: 1,
            label: 'app.kubernetes.io/component=primary; app.kubernetes.io/instance=mariadb; app.kubernetes.io/managed-by=Helm; app.kubernetes.io/name=mariadb; helm.sh/chart=mariadb-9.3.0',
            _clusterNamespace: 'fxiang-eks',
