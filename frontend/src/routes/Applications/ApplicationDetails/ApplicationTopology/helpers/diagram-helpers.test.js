                    ...
                    metadata: {
                        ...
                        labels: {
                            'apps.open-cluster-management.io/hosting-subscription':
                                'feng-wordpress.feng-wordpress-subscription-1',
                        },
                        name: 'feng-wordpress-subscription-1',
                        namespace: 'feng-wordpress',
                        ownerReferences: [
            ...
            searchClusters: [
                {
                    ...
                    addon: 'application-manager=true; cert-policy-controller=true; cluster-proxy=true; config-policy-controller=true; governance-policy-framework=true; iam-policy-controller=true; observability-controller=false; search-collector=false; work-manager=true',
                ...
                'feng-wordpress-subscription-1-local-local-cluster-feng-wordpress': [
                    {
                        ...
                        label: 'app=feng-wordpress; app.kubernetes.io/part-of=feng-wordpress; apps.open-cluster-management.io/reconcile-rate=medium',
                        localPlacement: 'true',
