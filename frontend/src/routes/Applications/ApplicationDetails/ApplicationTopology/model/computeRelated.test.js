                                ...
                                items: [
                                    {
                                        ...
                                        apiversion: 'v1',
                                        channel:
                                            'ggithubcom-simondelord-acm-templates-ns/ggithubcom-simondelord-acm-templates',
                                        cluster: 'local-cluster',
                        ...
                        metadata: {
                            annotations: {
                                ...
                                'apps.open-cluster-management.io/git-current-commit':
                                    '35dec8c199dcd7c0e651da03094156968e5d92f7',
                            ...
                            metadata: {
                                ...
                                labels: {
                                    'apps.open-cluster-management.io/hosting-subscription':
                                        'feng-bz.feng-bz-subscription-1',
                                },
                                name: 'feng-bz-subscription-1',
                                namespace: 'feng-bz',
                                ownerReferences: [
                                ...
                                clusters: [
                                    {
                                        ...
                                        kubeApiServer:
                                            'https://api.app-aws-410-hub-fpgwc.dev06.red-chesterfield.com:6443',
                                        consoleURL:
                                            'https://console-openshift-console.apps.app-aws-410-hub-fpgwc.dev06.red-chesterfield.com',
                                        isHive: false,
                                        isHypershift: false,
...
describe('addDiagramDetails with specs resources', () => {
    const mockData = {
        resourceStatuses: {
            data: {
                searchResult: [
    ...
    it('addDiagramDetails with project with specs resources', async () => {
        const result = {
            'cluster-local-cluster-local-cluster': {
                id: 'member--clusters--local-cluster--feng-bz-subscription-1',
                name: 'local-cluster',
