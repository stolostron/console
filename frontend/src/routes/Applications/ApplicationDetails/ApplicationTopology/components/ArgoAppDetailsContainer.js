...
class ArgoAppDetailsContainer extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            expandSectionToggleMap:
                props.argoAppDetailsContainerControl.argoAppDetailsContainerData.expandSectionToggleMap,
    ...
    render() {
        ...
        for (let i = startIdx; i < displayArgoAppList.length && i < page * perPage; i++) {
            const { name, cluster, namespace, destinationName, destinationNamespace, healthStatus } =
