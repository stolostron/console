                ...
                <g id="Product-Topology-Legend-Template" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="Basic-Node-B-Copy-9" transform="translate(197.000000, 7.000000)">
                        ...
                        <path
                            ...
                            fill-rule="nonzero"
                        ></path>
                        <g id="Node-Title" transform="translate(0.000000, 53.000000)">
                            <rect
                                id="Rectangle"
                                stroke="#3E8635"
                                fill="#FFFFFF"
                                ...
                                rx="3"
                            ></rect>
                            <g id="Group-4" transform="translate(1.000000, 25.000000)" fill="#D8D8D8">
                                <rect id="Rectangle" x="0" y="0" width="105" height="1"></rect>
                            </g>
                            <text font-family="RedHatText" font-size="14" font-weight="normal" fill="#212427">
                                <tspan x="21" y="18">
                                    {t('Cluster')}
                                </tspan>
                            </text>
            ...
            <symbol viewBox="0 0 350 120" id="drawerShapes_legend2">
                <g id="Legend" transform="translate(-340.000000, 0)">
                    ...
                    >
                            ...
                            <g id="Node-Group-Collapsed-Copy-7" fill-rule="nonzero">
                                <g id="Basic-Node">
                                    ...
                                    <path
                                        ...
                                        fill="#F5F5F5"
                                    ></path>
                                    <circle id="Oval" stroke="#D1D1D1" fill="#FFFFFF" cx="24" cy="24" r="24"></circle>
                                    <path
                        ...
                        <g id="Group-2-Copy" transform="translate(344.000000, 60.000000)">
                            <rect
                                id="Rectangle"
                                stroke="#3E8635"
                                fill="#FFFFFF"
