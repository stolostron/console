...
describe("ChannelController with noAllChannels", () => {
  ...
  beforeEach(async () => {
    ...
    await waitFor(() => expect(container.querySelector(`button[id="comboChannel"]`)).toBeTruthy())
  })
...
describe("ChannelController components 1", () => {
  ...
  beforeEach(async () => {
    ;({ container } = render(
      <ChannelController channelControl={channelController} t={t} />
    ))
...
describe("ChannelController components 2", () => {
  ...
  beforeEach(async () => {
    ;({ container } = render(
      <ChannelController channelControl={channelController2} t={t} />
    ))
...
describe("ChannelController components 2. 2", () => {
  ...
  it("ChannelController components 2 2", () => {
    ...
    userEvent.click(container.querySelector(`.pf-c-form-control`))
    userEvent.type(container.querySelector(`.pf-c-form-control`), '{enter}')
  });
});
...
describe("ChannelController components 3", () => {
  ...
  beforeEach(async () => {
    ;({ container } = render(
      <ChannelController channelControl={channelController3} t={t} />
    ))
...
describe("ChannelController components 4", () => {
  ...
  beforeEach(async () => {
    ;({ container } = render(
      <ChannelController channelControl={channelController4} t={t} />
    ))
