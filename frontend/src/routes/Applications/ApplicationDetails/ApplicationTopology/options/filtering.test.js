    ...
    specs: {
      ...
      raw: {
        ...
        metadata: {
          ...
          selfLink: '/apis/apps.open-cluster-management.io/v1/namespaces/ns-sub-1/placementrules/towhichcluster',
...
describe('getAllFilters', () => {
  ...
  it('should get all filters', () => {
    expect(
      getAllFilters(mockData.isLoaded, nodes, options, activeFilters, mockData.knownTypes, mockData.userIsFiltering, t)
...
describe('filterRelationshipNodes', () => {
  ...
  it('filter node by cluster name', () => {
    expect(filterRelationshipNodes(mockDataRelationshipNodes.nodes, mockDataRelationshipNodes.activeFilters)).toEqual(
      expectedValue
    )
  })
})
