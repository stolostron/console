    ...
    args: [
        {
            ...
            links: [
                ...
                {
                    source: 'member--clusters--local-cluster--test3-subscription-2',
                    target: 'member--deployed-resource--member--clusters--local-cluster--test3-subscription-2--test--helloworld-app-svc3--service',
                    label: '',
                    type: '',
                },
                {
                    source: 'member--deployed-resource--member--clusters--local-cluster--test3-subscription-2--test--helloworld-app-route--route',
                    target: 'member--deployed-resource--member--deployed-resource--member--clusters--local-cluster--test3-subscription-2--test--helloworld-app-route--route--test--helloworld-app-svc--service',
                    label: '',
                    type: '',
                },
                {
                ...
                },
                {
                    ...
                    target: 'member--deployed-resource--member--clusters--local-cluster--test3-subscription-2------deployment--replicaset--',
                    label: '',
                    type: '',
                },
                {
                    source: 'member--deployed-resource--member--clusters--local-cluster--test3-subscription-2------deployment--replicaset--',
                    target: 'member--deployed-resource--member--clusters--local-cluster--test3-subscription-2------deployment--replicaset----pod--',
                    label: '',
                    type: '',
                },
            ],
                            ...
                            'pause-deploy3-local-cluster': [
                                {
                                    ...
                                    label: 'app=pause-app; app.kubernetes.io/part-of=test3; apps.open-cluster-management.io/reconcile-rate=medium',
                                    name: 'pause-deploy3',
                                    namespace: 'test',
                                    ready: '1',
                                    resStatus: '1/1',
