    ...
    elements: {
        ...
        links: [
            ...
            },
            {
                ...
                target: 'member--deployed-resource--member--clusters--local-cluster--test3-subscription-1--undefined--cars.feng.example.com--customresourcedefinition',
                label: '',
                type: '',
            },
            {
            ...
            },
            {
                ...
                target: 'member--deployed-resource--member--clusters--local-cluster--test3-subscription-2--test--helloworld-app-route--route',
                label: '',
                type: '',
            },
            {
                source: 'member--clusters--local-cluster--test3-subscription-2',
                target: 'member--deployed-resource--member--clusters--local-cluster--test3-subscription-2--test--helloworld-app-svc2--service',
                label: '',
                type: '',
            },
        ],
                    ...
                    searchClusters: [
                        {
                            ...
                            cluster: '',
                            consoleURL:
                                'https://console-openshift-console.apps.cs-aws-412-wc9m9.dev02.red-chesterfield.com',
                            cpu: '24',
                        ...
                        'test3-subscription-1-local-local-cluster': [
                            {
                                ...
                                label: 'app=test3; app.kubernetes.io/part-of=test3; apps.open-cluster-management.io/reconcile-rate=medium',
                                localPlacement: 'true',
                    ...
                    clusters: [
                        {
                            ...
                            distribution: {
                                ...
                                ocp: {
                                    channel: 'stable-4.12',
                                    desired: {
                                        image: 'quay.io/openshift-release-dev/ocp-release@sha256:b83381ad349bdd535d27a6ae2d78e5a148a9f8930379818ad7a6b6b7303fe2a7',
                                        version: '4.12.0-ec.4',
                                    },
                    ...
                    template: {
                        template: {
                            ...
                            metadata: {
                                annotations: {
                                    'apps.open-cluster-management.io/hosting-subscription':
                                        'test/test3-subscription-2-local',
                                    'apps.open-cluster-management.io/reconcile-option': 'merge',
                                    'openshift.io/host.generated': 'true',
                                },
                                labels: {
                                ...
                                ingress: [
                                    {
                                        ...
                                        host: 'helloworld-app-route-test.apps.cs-aws-412-wc9m9.dev02.red-chesterfield.com',
                                        routerCanonicalHostname:
                                            'router-default.apps.cs-aws-412-wc9m9.dev02.red-chesterfield.com',
                                        routerName: 'default',
                                        wildcardPolicy: 'None',
                                    },
                                ],
                        ...
                        'helloworld-app-route-local-cluster': [
                            {
                                ...
                                kind: 'Route',
                                kind_plural: 'routes',
                                label: 'app=helloworld-app; app.kubernetes.io/part-of=test3; apps.open-cluster-management.io/reconcile-rate=medium',
                                name: 'helloworld-app-route',
                                namespace: 'test',
                                resStatus: 'deployed',
                                pulse: 'green',
