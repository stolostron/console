...
describe('getClusterCountSearchLink', () => {
    const resource = {
        apiVersion: 'apps/v1',
        kind: 'StatefulSet',
        label: 'app.kubernetes.io/component=application-controller; app.kubernetes.io/managed-by=openshift-gitops; app.kubernetes.io/name=openshift-gitops-application-controller; app.kubernetes.io/part-of=argocd',
        metadata: {
            name: 'argocd',
