...
import {VALIDATE_ALPHANUMERIC, VALIDATE_NUMERIC} from 'C:/Users/jswanke/git/temptifly/src'//'temptifly'
...
const ApplicationCreationPage = [
  ...
  {label: 'GPU Accelerated Compute',
    children: [
      {label: 'NC-series',
        children: [
          {value: 'Standard_NC6',   description: '6 vCPU, 56 GiB, 12 GPUs, 24 GPU GiB- GPU Accelerated Compute'},
          {value: 'Standard_NC12',   description: '12 vCPU, 112 GiB, 24 GPUs, 48 GPU GiB- GPU Accelerated Compute'},
          {value: 'Standard_NC24',   description: '24 vCPU, 224 GiB, 4 GPUs, 48 GPU GiB- GPU Accelerated Compute'},
          {value: 'Standard_NC24r',   description: '24 vCPU, 224 GiB, 4 GPUs, 48 GPU GiB- GPU Accelerated Compute'},
          {value: 'Standard_NC6s_v2',   description: '6 vCPU, 112 GiB, 16 GPUs, 12 GPU GiB- GPU Accelerated Compute'},
          {value: 'Standard_NC12s_v2',   description: '12 vCPU, 224 GiB, 2 GPUs, 32 GPU GiB- GPU Accelerated Compute'},
          {value: 'Standard_NC24s_v2',   description: '24 vCPU, 448 GiB, 4 GPUs, 64 GPU GiB- GPU Accelerated Compute'},
          {value: 'Standard_NC24rs_v2',   description: '24 vCPU, 448 GiB, GPUs, GPU GiB- GPU Accelerated Compute'},
          {value: 'Standard_NC6s_v3',   description: '6 vCPU, 112 GiB, 16 GPUs, 12 GPU GiB- GPU Accelerated Compute'},
          {value: 'Standard_NC12s_v3',   description: '12 vCPU, 224 GiB, 2 GPUs, 32 GPU GiB- GPU Accelerated Compute'},
          {value: 'Standard_NC24s_v3',   description: '24 vCPU, 448 GiB, 4 GPUs, 64 GPU GiB- GPU Accelerated Compute'},
          {value: 'Standard_NC24rs_v3',   description: '24 vCPU, 448 GiB, GPUs, GPU GiB- GPU Accelerated Compute'},
        ]
      },
      {label: 'ND-series',
        children: [
          {value: 'Standard_ND6s',   description: '6 vCPU, 112 GiB, GPUs,24 GPU 12GiB- GPU Accelerated Compute'},
          {value: 'Standard_ND12s',   description: '12 vCPU, 224 GiB, GPUs,48 GPU 24GiB- GPU Accelerated Compute'},
          {value: 'Standard_ND24s',   description: '24 vCPU, 448 GiB, GPUs,96 GPU 32GiB- GPU Accelerated Compute'},
          {value: 'Standard_ND24rs',   description: '24 vCPU, 448 GiB, GPUs, GPU GiB- GPU Accelerated Compute'},
        ]
      },
      {label: 'NV-series',
        children: [
          {value: 'Standard_NV6',   description: '6 vCPU, 56 GiB, GPUs, 8 GPU 24GiB- GPU Accelerated Compute'},
          {value: 'Standard_NV12',   description: '12 vCPU, 112 GiB, GPUs,16 GPU 48GiB- GPU Accelerated Compute'},
          {value: 'Standard_NV24',   description: '24 vCPU, 224 GiB, GPUs,4 GPU 32GiB- GPU Accelerated Compute'},
          {value: 'Standard_NV12s_v3',   description: '12 vCPU, 112 GiB, GPUs,8 GPU 12GiB- GPU Accelerated Compute'},
          {value: 'Standard_NV24s_v3',   description: '24 vCPU, 224 GiB, GPUs,16 GPU 24GiB- GPU Accelerated Compute'},
          {value: 'Standard_NV48s_v3',   description: '48 vCPU, 448 GiB, GPUs,4 GPU 32GiB- GPU Accelerated Compute'},
          {value: 'Standard_NV4as_v4',   description: '4 vCPU, 14 GiB, GPUs,2 GPU 4 GiB- GPU Accelerated Compute'},
          {value: 'Standard_NV8as_v4',   description: '8 vCPU, 28  GiB, GPUs,4  GPU 8 GiB- GPU Accelerated Compute'},
          {value: 'Standard_NV16as_v4',   description: '16 vCPU, 56 GiB, GPUs,8  GPU 16 GiB- GPU Accelerated Compute'},
        ]
      },
    ]
  },
