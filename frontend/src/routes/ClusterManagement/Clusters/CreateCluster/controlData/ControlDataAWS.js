...
import {CREATE_CLOUD_CONNECTION, LOAD_CLOUD_CONNECTIONS,
  LOAD_OCP_IMAGES, networkingControlData, labelControlData} from './ControlDataHelpers'
    ...
    children: [
      {label: 'P3 - NVIDIA Tesla V100 GPUs',
        children: [
          ...
          {value: 'p3.16xlarge',   description: '8 GPUs, 64 vCPU, 488 GiB, 128 GPU GiB- Accelerated Computing'},
          {value: 'p3dn.24xlarge',   description: '8 GPUs, 96 vCPU, 768 GiB, 256 GPU GiB- Accelerated Computing'},
        ]},
      {label: 'P2 - NVIDIA K80 GPUs',
        children: [
          ...
          {value: 'p2.16xlarge',   description: '16 GPUs, 64 vCPU, 732 GiB, 192 GPU GiB- Accelerated Computing'},
        ]},
      {label: 'G4 - NVIDIA T4 Tensor Core GPUs',
        children: [
          ...
          {value: 'g4dn.4xlarge',   description: '1 GPUs, 16 vCPU, 64 GiB, 16 GPU GiB- Accelerated Computing'},
          {value: 'g4dn.8xlarge',   description: '1 GPUs, 32 vCPU, 128 GiB, 16 GPU GiB- Accelerated Computing'},
          {value: 'g4dn.16xlarge',   description: '1 GPUs, 64 vCPU, 256 GiB, 16 GPU GiB- Accelerated Computing'},
          {value: 'g4dn.12xlarge',   description: '4 GPUs, 48 vCPU, 192 GiB, 64 GPU GiB- Accelerated Computing'},
          {value: 'g4dn.metal',   description: '8 GPUs, 96 vCPU, 384 GiB, 128 GPU GiB- Accelerated Computing'},
        ]},
      {label: 'G3 - NVIDIA Tesla M60 GPUs',
        children: [
          ...
          {value: 'g3.16xlarge',   description: '4 GPUs, 64 vCPU, 488 GiB, 32 GPU GiB- Accelerated Computing'},
        ]},
    ]
  },
