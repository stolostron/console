...
const PageActions = () => {
    ...
    const dropdownItems:AcmDropdownItems[] = [
        { id: 'create-cluster', text: t('managed.createCluster'), isDisabled: accessRestriction, tooltip:t('common:rbac.unauthorized')},
        { id: 'import-cluster', text: t('managed.importCluster'), isDisabled: accessRestriction, tooltip:t('common:rbac.unauthorized')},
    ]
