...
describe('Cluster page', () => {
    ...
    it('bulk deletes cluster', async () => {
        ...
        const nock = nockcreateSelfSubjectAccesssRequest(
            getDeleteClusterResourceAttributes(mockManagedCluster1.metadata.name!),
            true
        )
        nockcreateSelfSubjectAccesssRequest(
    ...
    it('bulk detaches cluster', async () => {
        ...
        const nock = nockcreateSelfSubjectAccesssRequest(
            getDeleteClusterResourceAttributes(mockManagedCluster2.metadata.name!),
            true
        )
        nockcreateSelfSubjectAccesssRequest(
            getDeleteClusterResourceAttributes(mockManagedCluster2.metadata.name!),
        ...
        nockcreateSelfSubjectAccesssRequest(
            getDeleteMachinePoolsResourceAttributes(mockManagedCluster2.metadata.name!),
            true
        )
        nockcreateSelfSubjectAccesssRequest(
            getClusterActionsResourceAttributes(mockManagedCluster2.metadata.name!),
            true
        )
        nockcreateSelfSubjectAccesssRequest(
            getCreateClusterViewResourceAttributes(mockManagedCluster2.metadata.name!),
            true
        )
        nockcreateSelfSubjectAccesssRequest(
            getDeleteDeploymentResourceAttributes(mockManagedCluster2.metadata.name!),
            true
        )
