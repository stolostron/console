        ...
        validationsInfo: {
            ...
            network: [
                ...
                },
                {
                    ...
                    message:
                        'Could not create the spoke k8s client connection using kubeconfig: could not load kubeconfig from internal storage with cluster id e9168554-bfbb-43d6-9b6c-f301ca02565e and filename kubeconfig: object e9168554-bfbb-43d6-9b6c-f301ca02565e/kubeconfig was not found',
                    status: 'error',
                },
            ],
            operators: [
...
const mockAgentMachine0 = {
    ...
    metadata: {
        annotations: {
            ...
            'hypershift.openshift.io/nodePoolPlatformMachineTemplate':
                '{"template":{"spec":{"agentLabelSelector":{}}}}',
        },
