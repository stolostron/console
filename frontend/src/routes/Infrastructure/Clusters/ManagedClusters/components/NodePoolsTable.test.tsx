  ...
  spec: {
    ...
    platform: {
      azure: {
        ...
        vnetID:
          '/subscriptions/da057d84-6570-41ea-83f7-f0f61a70542f/resourceGroups/jnp-az1-jnp-az1-jwkcl/providers/Microsoft.Network/virtualNetworks/jnp-az1-jnp-az1-jwkcl',
        subnetName: 'default',
...
const mockHostedCluster2: HostedClusterK8sResource = {
  ...
  spec: {
    ...
    release: {
      image:
        'quay.io/openshift-release-dev/ocp-release-nightly@sha256:e40fe4728e4071c99a961c431144a69fe4fda71d9ea63d850304e507316e671c',
    },
    secretEncryption: {
      aescbc: {
        activeKey: {
