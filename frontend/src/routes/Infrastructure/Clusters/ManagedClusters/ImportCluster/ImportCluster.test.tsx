  ...
  test('disabled for MultiClusterEngineHCP clusters', async () => {
    ...
    expect(
      container.querySelector(
        `[data-ouia-component-id=${mockDiscoveredClusters[0].metadata.uid!}] td.pf-v6-c-table__action`
      )?.innerHTML
    ).toBeDefined()
    expect(
      container.querySelector(
        `[data-ouia-component-id=${mockDiscoveredClusters[4].metadata.uid!}] td.pf-v6-c-table__action`
      )
    ).toBeEmptyDOMElement()
  })
})
