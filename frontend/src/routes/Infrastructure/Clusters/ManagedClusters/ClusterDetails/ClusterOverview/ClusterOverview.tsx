...
export function ClusterOverviewPageContent(props: { canGetSecret?: boolean }) {
    const { cluster, clusterCurator, clusterAnsibleJobs } = useContext(ClusterContext)
    ...
    let leftItems = [
        ...
        },
        {
            ...
            value: cluster?.distribution?.displayVersion && (
                <DistributionField cluster={cluster} clusterCurator={clusterCurator} ansibleJobs={clusterAnsibleJobs} />
            ),
        },
        {
            filterKey: 'channel',
