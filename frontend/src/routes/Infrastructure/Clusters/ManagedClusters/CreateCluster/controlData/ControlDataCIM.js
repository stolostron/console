...
export const useControlDataCIM = (handleModalToggle, warning, includeKlusterletAddonConfig = true) => {
    ...
    return useMemo(() => {
        ...
        return controlData
    }, [t, handleModalToggle, warning, includeKlusterletAddonConfig, automationControlData])
}

export default useControlDataCIM
