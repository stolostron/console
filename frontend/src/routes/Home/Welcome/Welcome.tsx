  ...
  const cards = useMemo(
    () => [
      ...
      },
      {
        ...
        title: t('Search'),
        description: t(
          'Search all environment recources in all clusters using predefined search parameters, or saveable custom search parameters. Searches return links to resource details including editable YAMLs and topologies when available.'
        ),
