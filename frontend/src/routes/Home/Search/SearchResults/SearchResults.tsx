...
function SearchResultTables(props: {
    ...
    const renderContent = useCallback(
        (kind: string, items: ISearchResult[]) => {
            ...
            // The following SearchDefinition strings for the SearchResults table need to be added to translations file:
            //
            // 'Access mode',
            // 'Active',
            // 'Architecture',
            ...
            // 'schedule',
            // 'Scope',
            // 'Scope refers to the cluster associated to the PolicyReport.',
            // 'Source',
            // 'Source type',
            // 'Status',
            // 'Successful',
            ...
            // 'Updated',
            // 'URL',
            // 'Use the rules filter to search for PolicyReports that contain a specific rule.',
            // 'Violations',
