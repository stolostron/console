...
import { isApplicationAction, isApplicationListColumn, isOverviewTab, isVirtualMachineAction, isVirtualMachineistColumn } from './extensions'
...
export function useAcmExtension() {
  ...
  const [virtualMachineListColumn, resolvedVirtualMachineListColumn] = useResolvedExtensions(isVirtualMachineistColumn)
