...
export type VirtualMachineListColumn = Extension<'acm.virtualmachine/list/column', ListColumnExtensionProps>

// Type guards
export const isApplicationListColumn = (e: Extension): e is ApplicationListColumn =>
  e.type === 'acm.application/list/column'
export const isVirtualMachineListColumn = (e: Extension): e is VirtualMachineListColumn =>
