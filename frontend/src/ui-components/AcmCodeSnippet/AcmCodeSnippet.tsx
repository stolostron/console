...
export function AcmCodeSnippet(props: {
  ...
  return (
    <div className="pf-v6-c-code-editor pf-m-read-only" style={{ display: 'flex' }} id={props.id}>
      <div className="pf-v6-c-code-editor__main" style={{ width: '100%' }}>
        <div className="pf-v6-c-code-editor__code">
          <pre className="pf-v6-c-code-editor__code-pre">{props.fakeCommand ?? props.command}</pre>
        </div>
      </div>
      <ClipboardCopyButton
        exitDelay={500}
