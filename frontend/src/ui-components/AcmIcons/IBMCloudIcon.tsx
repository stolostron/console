...
export const IBMCloudIcon = createAcmIcon({
  xOffset: 0,
  yOffset: 4,
  width: 64,
  height: 64,
  svgPaths: (
    <Fragment>
      ...
      <mask className="ibm-icon" maskUnits="userSpaceOnUse" x="79.3" y="86.2" width="188.1" height="166.2" id="prefix__e">
        <g filter="url(#prefix__a)">
          ...
          <path
            ...
            fill="url(#prefix__b)"
          />
          <path className="mask" d="M218.6 252.4h-98.2c-22.8-.2-41.1-18.7-40.9-41.5l7.1.1c-.1 18.8 15 34.2 33.8 34.4h98.1c23 0 41.6-18.6 41.7-41.6 0-10.2-3.8-20.1-10.6-27.8l5.3-4.7c17.9 20.1 16.2 50.9-3.8 68.8-9 7.9-20.5 12.3-32.5 12.3z" />
          <linearGradient
            id="prefix__c"
            gradientUnits="userSpaceOnUse"
            x1="75.254"
      ...
      <linearGradient id="prefix__f" gradientUnits="userSpaceOnUse" x1="234.367" y1="65.613" x2="120.164" y2="259.491">
        <stop offset="0" stopColor="#50ffd2" />
        <stop offset="1" stopColor="#0064ff" />
      </linearGradient>
      <path className="ibm-icon base"
