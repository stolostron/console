...
describe('AcmTextArea', () => {
  ...
  test('does not render when hidden is true', () => {
    const { queryByTestId, queryByText } = render(
      <AcmTextArea id="hidden-input" label="Hidden Label" value="test" onChange={() => null} hidden />
    )
  ...
  test('skips validation when hidden is true', async () => {
    const Component = () => {
      ...
      return (
        <AcmForm>
          <AcmTextArea id="hidden-input" label="Hidden Label" value="" onChange={() => null} isRequired hidden />
          <AcmSubmit>Submit</AcmSubmit>
