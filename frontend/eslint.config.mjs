...
export default defineConfig([globalIgnores(["**/*.json"]), {
    ...
    rules: {
        ...
        "@typescript-eslint/no-restricted-imports": ["error", {
            paths: [{
                ...
                message: "Please use hooks from ./src/hooks/shared-react-query for ACM/MCE dynamic plugins common QueryClientProvider",
