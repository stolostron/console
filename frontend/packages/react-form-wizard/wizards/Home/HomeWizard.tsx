          ...
          <Indented>
            <DescriptionList isHorizontal isCompact>
              ...
              <DescriptionListGroup>
                ...
                <DescriptionListDescription>
                  The <a href="https://github.com/jonschlinkert/set-value#object-paths">path</a> the input is getting
                  and setting value to, in the current item context.
                </DescriptionListDescription>
              </DescriptionListGroup>
              <DescriptionListGroup>
              ...
              <DescriptionListGroup>
                ...
                <DescriptionListDescription>
                  Optional validation function that takes in the current item context and input value. It should return
                  an error string if there is an error.
                </DescriptionListDescription>
              </DescriptionListGroup>
              <DescriptionListGroup>
                <DescriptionListTerm>hidden</DescriptionListTerm>
                <DescriptionListDescription>
                  Optional hidden function that takes in the current item context and returns true if the input should
                  be hidden.
                </DescriptionListDescription>
              </DescriptionListGroup>
            </DescriptionList>
