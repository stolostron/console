  ...
  return (
    <WizardPage title="Inputs" onSubmit={onSubmit} onCancel={() => onCancel(history)}>
      ...
      <Step label="Table Select" id="table-select">
        <Section
          label="Table Select"
          description="Table select is used when many selections can be made from many options."
        >
          <WizTableSelect
            id="string"
            path="tableSelect"
      ...
      <Step label="Hidden" id="hidden-step">
        ...
        <Section
          label="Automatically hidden"
          description="A section will automatically hide itelf if all child inputs are hidden."
        >
          <WizTextInput
            label="Text input hidden"
            path="hidden.textInput"
          ...
          <WizCheckbox
            label="Checkbox conditionally hidden"
            path="hidden.checkbox"
            hidden={(item) => !item.showHidden}
          />
        </Section>
      </Step>
