...
import {
  ...
  EditPolicyAutomation,
  PolicyAutomationExamples,
} from './PolicyAutomation/PolicyAutomationExamples'
import {
  CreatePolicySet,
  EditPolicySet1,
  EditPolicySet2,
  ...
  return (
    <BrowserRouter>
      <Page
        ...
        style={{
          height: '100vh',
          ['--pf-v6-c-page__main-container--BorderColor' as any]: '#f2f2f2',
          ['--pf-v6-c-page__main-container--MarginInlineEnd' as any]: 0,
        }}
      >
        <DemoRouter />
      </Page>
...
function DemoHeader() {
  return (
    <Masthead display={{ default: 'inline' }}>
      <MastheadMain>
        <MastheadToggle>
          <PageToggleButton isHamburgerButton variant="plain" aria-label="Global navigation"></PageToggleButton>
        </MastheadToggle>
        <MastheadBrand>
          <MastheadLogo>
            <div style={{ display: 'flex', gap: 8, alignItems: 'start' }}>
              ...
              <div style={{ color: 'black' }}>
                ...
                <Title headingLevel="h4" style={{ fontWeight: 'lighter', lineHeight: 1.3 }}>
                  React Form Wizard
                </Title>
              </div>
            </div>
