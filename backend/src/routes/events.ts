...
const definitions: IWatchOptions[] = [
  ...
  { kind: 'CertificatePolicy', apiVersion: 'policy.open-cluster-management.io/v1' },
  ...
  { kind: 'OperatorPolicy', apiVersion: 'policy.open-cluster-management.io/v1beta1' },
  ...
  { kind: 'ConfigurationPolicy', apiVersion: 'policy.open-cluster-management.io/v1' },
