...
const definitions: IWatchOptions[] = [
    ...
    { kind: 'ManagedClusterSet', apiVersion: 'cluster.open-cluster-management.io/v1alpha1' },
    { kind: 'ManagedClusterSetBinding', apiVersion: 'cluster.open-cluster-management.io/v1alpha1' },
